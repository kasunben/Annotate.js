...
| **Settings** | **About** (app name, version via esbuild `--define`, sync mode chip, privacy note, GitHub link) · Display name · **Export / Import** (download JSON / import JSON; always visible in all modes) · "Clear all annotations" (offline/BC mode only; hidden in server-sync and P2P) | global |
